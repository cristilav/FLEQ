...
urlpatterns = patterns('',
	...
	url('^help$', 'fleq.quizbowl.views_custom_connect.help'),
	...
	url('^analytics/categories/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Categoriesgid'),
   	...
   	url('^analytics/absences2/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Absencesmedium'),
   	...
   	url('^analytics/gamesround/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.QuestionRoundssgid'),
   	url('^analytics/maxsuccesstime/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.MaxSuccesstimegid'),
   	
   	url('^analytics/summary/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Summarygid'),
   	url('^analytics/gamesmedium/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Questionmediumsgid'),
 	url('^analytics/user_statistics/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Usersgid'),
 	url('^analytics/usersnoplaygid/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Usersnoplaygid'),
 	url('^analytics/userswinnerquestions/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Userswinnerquestions'),
 	url('^analytics/qmoreappear/(?P<gid>\d+)$', 'fleq.quizbowl.views_custom_analytics.Questionsmoreappear'),
