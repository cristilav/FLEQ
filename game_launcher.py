...
three_minutes_ahead = datetime.datetime.utcnow() + datetime.timedelta(minutes=3) 
g = Game.objects.filter(start_time__lte = three_minutes_ahead, start_time__gte = datetime.datetime.utcnow())
